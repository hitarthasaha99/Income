    ...
    public class Database
    {
        ...
        private async Task CreateIndexesAsync()
        {
            var indexCommands = new[]
            {
                ...
                "CREATE INDEX IF NOT EXISTS idx_sch_0_block_2_id ON Tbl_Sch_0_0_Block_2(id);",
                "CREATE INDEX IF NOT EXISTS idx_sch_0_block_3_id ON Tbl_Sch_0_0_Block_3(id);",
                "CREATE INDEX IF NOT EXISTS idx_sch_0_block_4_1_id ON Tbl_Sch_0_0_Block_4_1(id);",
                "CREATE INDEX IF NOT EXISTS idx_sch_0_block_4_2_id ON Tbl_Sch_0_0_Block_4_2(id);",
                "CREATE INDEX IF NOT EXISTS idx_sch_0_block_4_3_id ON Tbl_Sch_0_0_Block_4_3(id);",
