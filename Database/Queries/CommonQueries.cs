    ...
    public class CommonQueries : Database
    {
        ...
        public async Task<string> DeleteBlockDataForCasulaty()
        {
            ...
            try
            {
                ...
                await _database.ExecuteAsync($@"DELETE FROM Block_4_1 WHERE fsu_id = {SessionStorage.SelectedFSUId} AND hhd_id = {SessionStorage.selected_hhd_id} AND tenant_id = {SessionStorage.tenant_id} AND survey_id = '{SessionStorage.surveyId}'");
                await _database.ExecuteAsync($@"DELETE FROM Block_4_1_Item_3 WHERE fsu_id = {SessionStorage.SelectedFSUId} AND hhd_id = {SessionStorage.selected_hhd_id} AND tenant_id = {SessionStorage.tenant_id} AND survey_id = '{SessionStorage.surveyId}'");
                await _database.ExecuteAsync($@"DELETE FROM Block_5_1 WHERE fsu_id = {SessionStorage.SelectedFSUId} AND hhd_id = {SessionStorage.selected_hhd_id} AND tenant_id = {SessionStorage.tenant_id} AND survey_id = '{SessionStorage.surveyId}'");
                await _database.ExecuteAsync($@"DELETE FROM Block_5_2 WHERE fsu_id = {SessionStorage.SelectedFSUId} AND hhd_id = {SessionStorage.selected_hhd_id} AND tenant_id = {SessionStorage.tenant_id} AND survey_id = '{SessionStorage.surveyId}'");
                await _database.ExecuteAsync($@"DELETE FROM Block_6_1 WHERE fsu_id = {SessionStorage.SelectedFSUId} AND hhd_id = {SessionStorage.selected_hhd_id} AND tenant_id = {SessionStorage.tenant_id} AND survey_id = '{SessionStorage.surveyId}'");
                await _database.ExecuteAsync($@"DELETE FROM Block_6_2 WHERE fsu_id = {SessionStorage.SelectedFSUId} AND hhd_id = {SessionStorage.selected_hhd_id} AND tenant_id = {SessionStorage.tenant_id} AND survey_id = '{SessionStorage.surveyId}'");
                await _database.ExecuteAsync($@"DELETE FROM Block_7 WHERE fsu_id = {SessionStorage.SelectedFSUId} AND hhd_id = {SessionStorage.selected_hhd_id} AND tenant_id = {SessionStorage.tenant_id} AND survey_id = '{SessionStorage.surveyId}'");
                await _database.ExecuteAsync($@"DELETE FROM Block_8 WHERE fsu_id = {SessionStorage.SelectedFSUId} AND hhd_id = {SessionStorage.selected_hhd_id} AND tenant_id = {SessionStorage.tenant_id} AND survey_id = '{SessionStorage.surveyId}'");
                await _database.ExecuteAsync($@"DELETE FROM Block_8_1 WHERE fsu_id = {SessionStorage.SelectedFSUId} AND hhd_id = {SessionStorage.selected_hhd_id} AND tenant_id = {SessionStorage.tenant_id} AND survey_id = '{SessionStorage.surveyId}'");
                await _database.ExecuteAsync($@"DELETE FROM Block_9 WHERE fsu_id = {SessionStorage.SelectedFSUId} AND hhd_id = {SessionStorage.selected_hhd_id} AND tenant_id = {SessionStorage.tenant_id} AND survey_id = '{SessionStorage.surveyId}'");
                await _database.ExecuteAsync($@"DELETE FROM Block_9_1 WHERE fsu_id = {SessionStorage.SelectedFSUId} AND hhd_id = {SessionStorage.selected_hhd_id} AND tenant_id = {SessionStorage.tenant_id} AND survey_id = '{SessionStorage.surveyId}'");
