...
namespace Income.Validators.HIS2026
{
    public class Block_11a_Validator : AbstractValidator<Tbl_Block_11a>
    {
        public Block_11a_Validator()
        {
            ...
            //RuleFor(x => x.item_3).NotNull().WithMessage("H072: Invalid Entry, Please check the entry").InclusiveBetween(1, 2).WithMessage("H072: Invalid Entry, Please check the entry");
