    ...
    public class Block7Validator : AbstractValidator<Tbl_Sch_0_0_Block_7>
    {
        public Block7Validator()
        {
            ...
            When(x => x.is_household == 2, () =>
            {
                ...
                RuleFor(x => x.Block_7_8).NotEmpty().WithMessage("Total amount of land owned is required").GreaterThanOrEqualTo(0).WithMessage("Value must be greater than/equal to 0").When(x => SessionStorage.FSU_Sector == 1);
